export default [
  ...
  },
  {
    ...
    learn: [
      ...
      '<b>Vuex</b>를 통한 상태관리로 큰 프로젝트에서 데이터를 어떻게 나누고 관리하는지 경험할 수 있었습니다.',
      'HOC, teleoprt, slot 등 Vue를 더욱 효과적으로 사용하기 위한 개념들을 언제, 어떻게 사용할지 고민하고 시도해볼 수 있었습니다.',
      'Vue 환경에서 GSAP를 적용하며 <b>lifecycle</b>에 대해 이해하고 적절하게 사용해볼 수 있었습니다.',
      'fxdom, fxjs를 사용하며 함수형 프로그래밍을 접할 수 있었습니다.',
      '일정에 제한이 없는 프로젝트였기 때문에, 많은 디테일들을 충분히 잡아갈 수 있었고 그에 따라 퀄리티가 올라가는 것을 직접 경험할 수 있었습니다.',
    ],
    work: [
      {
        video: '0.mp4',
      ...
      {
        video: '1.mp4',
        desc: '연락하기, 지도 보기 등 페이지에서 메신저의 해당 기능을 바로 열 수 있도록 작업했습니다. 반대로 메신저에서 프로젝트 보기, 바로가기 링크를 통해 원하는 페이지로 이동할 수 있게 하여 사이트 전체를 메신저로 연결했습니다.',
      },
      {
        video: '2.mp4',
        number: '02',
  ...
  },
  {
    ...
    learn: [
      ...
      '회사 내부 프로젝트로, 디자인이 제한 없이 변경되는 경우가 많았습니다. 공통으로 사용되는 요소를 수정할 때, 전체에 어떤 영향을 미칠지 고려하면서 코드를 리펙토링해볼 수 있었습니다.',
      '처음으로 백엔드 개발자와 소통하며 코드를 수정하는 경험을 할 수 있었습니다.',
    ],
    // work: [
    //   {
    //     image: '0.gif',
  ...
  },
  {
    ...
    work: [
      ...
      },
      {
        ...
        number: '03',
        title: '공통 작업',
        desc: '헤더 텍스트를 모든 페이지에 적용되도록 작업했습니다. ',
      },
      {
        image: '3.jpg',
      },
